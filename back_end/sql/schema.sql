...
CREATE TABLE IF NOT EXISTS Customers (
    cst_id VARCHAR(100) PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS FamilyLists(
    fl_id VARCHAR(100) PRIMARY KEY,
    cst_id VARCHAR(100) NOT NULL,
...
INSERT INTO Nationality (nationality_code, nationality_name) VALUES
('AF', 'Afghanistan'),
('AX', 'Aland Islands'),
('AL', 'Albania'),
('DZ', 'Algeria'),
